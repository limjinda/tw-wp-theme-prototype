...
function wp_theme_setup() {
	 ...
	 */
	load_theme_textdomain( 'theme_prototype' );
	...
	register_nav_menus( array(
		// 'top'    => __( 'Top Navigation', 'theme_prototype' ),
		// 'social' => __( 'Footer Sitemap', 'theme_prototype' ),
	) );
...
function wp_theme_register_script() {
	 ...
	 */
	// wp_enqueue_style('wp-vendor', get_theme_file_uri('/dist/vendor/vendor.css'), array(), rand(1,100));
	// wp_enqueue_style('wp-style', get_stylesheet_uri(), array(), rand(1,100));
	
	/**
	 * Register js script file(js/client.js) 
	 * dependency on jQuery, and place this before close body tag
	 */
	// wp_register_script('wp-vendor', get_theme_file_uri('/dist/vendor/vendor.js'), array('jquery'), true);
	// wp_enqueue_script_module('wp-client', get_theme_file_uri('/dist/main.js'), null, true);
